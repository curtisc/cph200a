...
# OPTIMIZED FOR 8× H100 GPUs (80GB) - MAXIMUM ACCURACY (Video ResNet)
...
echo "8× H100 Configuration: ResNet18Video3D MAXIMUM ACCURACY"
...
python main.py \
  ...
  \
  --project_name nlst_h100_video3d_accuracy

echo ""
echo "Maximum accuracy Video ResNet training complete!"
