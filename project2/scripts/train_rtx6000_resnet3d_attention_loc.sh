...
# OPTIMIZED FOR 2× RTX 6000 Pro GPUs (96GB) - ATTENTION + LOCALIZATION (ResNet18_3D)
# Hardware: 16-core CPU, 128GB RAM, PCIe x8 per GPU (no NVLink)
# Model: ResNet18_3D with attention pooling + localization regularization
...
echo "2× RTX 6000 Pro Configuration: ResNet18_3D ATTENTION + LOCALIZATION"
...
python main.py \
  ...
  \
  --project_name nlst_rtx6000_resnet3d_attention_loc

echo ""
echo "ResNet18_3D with attention + localization training complete!"
