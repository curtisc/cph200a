...
################################################################################
# SUPER SCRIPT: Run All Models with Attention + Localization
################################################################################
...
#
# Total estimated time: ~18-24 hours (6-8 hours per model)
# System: 8× H100 GPUs, 1.73TB RAM
################################################################################

set -e  # Exit on error

echo "=============================================================================="
echo "STARTING ALL ATTENTION + LOCALIZATION EXPERIMENTS"
echo "=============================================================================="
echo "This will run 3 models in serial:"
echo "  1. CNN3D (6-8 hours)"
echo "  2. ResNet18_3D (6-8 hours)"
echo "  3. ResNet18Video3D (6-8 hours)"
echo ""
echo "Total estimated time: 18-24 hours"
...
EXP1_START=$(date +%s)
bash /home/ubuntu/CPH200A/project2/scripts/train_h100_cnn3d_attention_loc.sh
EXP1_END=$(date +%s)
...
EXP2_START=$(date +%s)
bash /home/ubuntu/CPH200A/project2/scripts/train_h100_resnet3d_attention_loc.sh
EXP2_END=$(date +%s)
...
EXP3_START=$(date +%s)
bash /home/ubuntu/CPH200A/project2/scripts/train_h100_video3d_attention_loc.sh
EXP3_END=$(date +%s)
...
echo "  - nlst_h100_cnn3d_attention_loc"
echo "  - nlst_h100_resnet3d_attention_loc"
echo "  - nlst_h100_video3d_attention_loc"
echo ""
