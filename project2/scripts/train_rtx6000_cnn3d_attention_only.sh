...
# OPTIMIZED FOR 2× RTX 6000 Pro GPUs (96GB) - ATTENTION POOLING (CNN3D)
# Hardware: 16-core CPU, 128GB RAM, PCIe x8 per GPU (no NVLink)
# Model: CNN3D with spatial attention pooling
...
echo "2× RTX 6000 Pro Configuration: CNN3D ATTENTION POOLING"
...
echo "Expected: 0.79-0.82 AUC in 24-32 hours"
echo ""
...
python main.py \
  ...
  \
  --project_name nlst_rtx6000_cnn3d_attention

echo ""
echo "CNN3D with attention pooling training complete!"
