...
# OPTIMIZED FOR 2× RTX 6000 Pro GPUs (96GB) - LOCALIZATION ONLY (ResNet18_3D)
# Hardware: 16-core CPU, 128GB RAM, PCIe x8 per GPU (no NVLink)
# Model: ResNet18_3D with localization regularization (no attention pooling)
# Focus: Explore localization regularization without attention mechanism
...
echo "2× RTX 6000 Pro Configuration: ResNet18_3D LOCALIZATION REGULARIZATION"
echo "Full resolution: 256×256×200"
echo "Feature: Localization regularization (no attention pooling)"
echo "Effective batch size: 6 (3 per GPU × 2)"
echo "Workers: 10 total (RAM-limited)"
echo "Expected: 0.80-0.83 AUC in 32-40 hours"
echo ""
...
python main.py \
  ...
  \
  --project_name nlst_rtx6000_resnet3d_localization

echo ""
echo "ResNet18_3D with localization regularization training complete!"
echo "Ablation study: localization without attention pooling."
