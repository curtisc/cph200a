...
# OPTIMIZED FOR 2× RTX 6000 Pro GPUs (96GB) - MAXIMUM ACCURACY (ResNet18Video3D)
...
# - Conservative batch size for large model

echo "2× RTX 6000 Pro Configuration: ResNet18Video3D MAXIMUM ACCURACY"
...
python main.py \
  ...
  \
  --project_name nlst_rtx6000_video3d_accuracy

echo ""
echo "Maximum accuracy ResNet18Video3D training complete!"
